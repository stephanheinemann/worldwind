...
public class Plot extends Canvas {
	...
	public synchronized void addPoint(double newx, double newy, String id) {
		...
		l.setBounds(pixelx+2, pixely-2, 3, 3);
		plotFrame.add(l);
	}
	...
	public static void main(String[] args) {
		Plot plot = new Plot("Hey", 88.10, 88.20, 0.00001, 44.8, 45.2, 0.00001);
		plot.setPointSize(6);
		plot.setBackground(Color.white);
		plot.setColor(Color.cyan);
		plot.addPoint(88.151670009845, 45, "");
	}
}